...
#d)
boxplot(COD,main="GrÃ¡fico tipo Boxplot",xlab="valor",col="red")
#Como a linha da mediana estÃ¡ prÃ³xima ao primeiro quartil,
#os dados sÃ£o assimÃ©tricos positivos.
...
#Como p-value=0.07419 < 0,1, se rejeita a hipótese nula. 
...
#estatisticamente significante. A autorização não deve ser fornecida.

#Para as 20 observações apresentadas, a indússtria está em conformidade com
#o padrão, exceto se considerado nível de significãncia de 10%, pois, nesse
